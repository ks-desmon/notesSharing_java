<%-- 
    Document   : about us
    Created on : Oct 20, 2017, 4:50:52 PM
    Author     : Desmon
--%>
    ...
    <body>
        ...
        <div class="container">
            <form action="view_recoverpassword.jsp" method="get">
                ...
                <table class="table">
                    <tr><td><h>Kundan 1814302 cse section A1</h></td></tr>
                    <tr><td><h>Vineet 1814306 cse section A1</h></td></tr>
                    <tr><td><h>Hema 1814402 cse section A3</h></td></tr>
                </table>
            </form>
        </div>
        <div class="footer">   
