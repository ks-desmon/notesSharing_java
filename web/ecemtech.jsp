<%-- 
    Document   : ecemtech
    Created on : Jul 22, 2017, 6:06:48 PM
    Author     : vinet
--%>
<%
    ...
    <body style="background-color: navajowhite">
        ...
        <table style="border:0; margin-left: 330px; margin-top: 50px;">
            ...
            <tr style="background-color: peru">
                ...
                <td align="center" style="padding: 10px;"><b><a href="img.jsp?Id=Semester 1&id2=ECE(M.TECH)"><font color="black">Semester 2</font></a></b></td>
            </tr>
            <tr>
                <td align="center" style="padding: 10px;"><b>3.</b></td>
                <td align="center" style="padding: 10px;"><b><a href="img.jsp?Id=Semester 1&id2=ECE(M.TECH)"><font color="black">Semester 3</font></a></b></td>
            </tr>
            <tr style="background-color: peru">
                <td align="center" style="padding: 10px;"><b>4.</b></td>
                <td align="center" style="padding: 10px;"><b><a href="img.jsp?Id=Semester 1&id2=ECE(M.TECH)"><font color="black">Semester 4</font></a></b></td>
            </tr>
        </table>
        <div class="footer">
